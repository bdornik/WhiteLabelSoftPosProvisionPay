package com.payten.whitelabel.async;
    ...
    protected void onPostExecute(PrinterStatus result) {
        ...
        switch (result.getPrinterStatus()) {
            case AsyncEscPosPrint.FINISH_SUCCESS:
                Utility.showDialogInfo(context,context.getResources().getString(R.string.label_printed),true, isDark);
                break;
            case AsyncEscPosPrint.FINISH_NO_PRINTER:
                Utility.showDialogInfo(context,context.getResources().getString(R.string.label_no_printed),false,isDark);
                break;
            case AsyncEscPosPrint.FINISH_PRINTER_DISCONNECTED:
                Utility.showDialogInfo(context,"Unable to connect the printer.",false,isDark);
                break;
            case AsyncEscPosPrint.FINISH_PARSER_ERROR:
                Utility.showDialogInfo(context,"It seems to be an invalid syntax problem.",false,isDark);
                break;
            case AsyncEscPosPrint.FINISH_ENCODING_ERROR:
                Utility.showDialogInfo(context,"The selected encoding character returning an error.",false,isDark);
                break;
